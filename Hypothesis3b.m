...
for eeg_file = 1:size(list_of_files)
    ...
    cd D:\Dropbox\Projects\EEGManyPipelines\Data\3a\
...
STUDY=[];
[STUDY ALLEEG]=std_editset(STUDY, ALLEEG, 'name', 'ERSP_Hypothesis3b',...
    'task', 'hit_miss', 'filename', 'ERSP_Hypothesis3b.study', 'filepath', ...
   'D:\Dropbox\Projects\EEGManyPipelines\Data\3a\');

STUDY = std_makedesign(STUDY, ALLEEG, 1, 'name','HitMiss','delfiles','off','defaultdesign','off','variable1','type','values1',{'hit','miss'},'vartype1','categorical','subjselect',{'sub-001','sub-002','sub-003','sub-004','sub-005','sub-006','sub-007','sub-008','sub-009','sub-010','sub-011','sub-012','sub-013','sub-014','sub-015','sub-016','sub-017','sub-018','sub-019','sub-020','sub-021','sub-022','sub-023','sub-024','sub-025','sub-026','sub-027','sub-028','sub-029','sub-030','sub-031','sub-032','sub-033'});
...
std_erspplot(STUDY, ALLEEG, 'channels', {ALLEEG(1).chanlocs(1:72).labels}, 'design', 1, 'plotconditions', 'together', 'timerange', [-200 800], 'alpha',0.05, 'mcorrect', 'fdr');