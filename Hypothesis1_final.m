...
%% STEP 3
% run t-test tfce
ept_TFCE(EEG_natural_all, EEG_manmade_all, EEG_natural.chanlocs, 'rSample', 512, 'nPerm', 5000, 'E_H', [0.66, 2], 'type', 'd', 'saveName', 'tfce_natural_mammade.mat');
...
%change structure of data for plotting toolbox
...
plot_topobutter(mean_permuted ,EEG_natural.times,EEG_natural.chanlocs,'pvalues',Results.P_Values, 'colormap',{{'div','RdYlBu'},{'seq','YlGnBu'},'seq'},'topoalpha',0.005)
